<template>
  <div class="c">
    ...
    <div class="p">
      <p>
        <b class="job-title">
          <span style="margin-right: 30px">Fullstack developer at Orange</span>
        ...
        Typescript, Git, Html, CSS, Bootstrap, Jenkins, VsCode, Jest, Jasmine,
        Mocha, Protractor, Jira, Con
      </p>
      <p>
        <b class="job-title">
